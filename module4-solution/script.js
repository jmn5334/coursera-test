...
// See Lecture 50, part 1
  ...
  namesWithGreetings = names.map(x => getGreeting(x));
  for(var i = 0; i < names.length; i++) {
  ...
  for(var i = 0; i < greetingArrays.hello.length; i++) {
    console.log(greetingArrays.hello[i]);
  }
  for(var i = 0; i < greetingArrays.bye.length; i++) {
    console.log(greetingArrays.bye[i]);
  }
